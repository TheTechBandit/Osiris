...
namespace Osiris
{
    public class BladeOfAres : BasicMove
    {
        public override string Name { get; } = "Blade of Ares";
        public override string Owner { get; } = "Odysseus";
        public override string Description { get; } = "Slash an enemy for 4d8 damage.";
        public override string TargetType { get; } = "SingleEnemy";
        public override int Targets { get; } = 1;
        public override bool IsUltimate { get; } = false;
        public override int Cooldown { get; } = 0;

        public BladeOfAres() : base()
        {
            
        }

        public BladeOfAres(bool newmove) : base(newmove)
        {
